          ...
          <div className='profile-page'>
            ...
            <div className='profile-container'>
              ...
              <h3 className='profile-name'>
                {boardMembersData.president.role}
              </h3>
              <p className='profile-description'>
                A VW owner since 15 and enthusiast since the womb. Mark's goals
                are to continue to Lead and keep the momentum going strong. A
                lover of all things Volkswagen, we can only hope his VW Guitar
                comes out for a performance in 2025.
              </p>
            </div>
            {/* Vice President Info */}
            <div className='profile-container'>
              ...
              <p className='profile-description'>
                {' '}
                A strong force of nature and nurture Jimmy will guide the Board
                into keeping its commitments to the Volkswagen Community in the
                Midwest. He supports our "collecting" and enjoys being the
                Club's BBQ Pitmaster.
              </p>
            </div>
            {/* Treasurer Info */}
            <div className='profile-container'>
              ...
              />
              <h3 className='profile-name'>
                {boardMembersData.treasurer.role}
              </h3>
              <p className='profile-description'>
            ...
            <div className='profile-container'>
              ...
              />
              <h3 className='profile-name'>
                {boardMembersData.secretary.role}
              </h3>
              <p className='profile-description'>
                The go-to for all things organized. She is the printshop for all
                Vinyl Decals for the Club. Amy's passion for helping the
                community allows us to give back and provide aid to direct
                resources.
              </p>
            </div>
            ...
            <div className='profile-container'>
              ...
              <p className='profile-description'>
                ...
                Building of our Club's dreams, even if I have to build it
                myself."
              </p>
            </div>
            ...
            <div className='profile-container'>
              ...
              <p className='profile-description'>
                ...
                updated as can be. Mindy will be maintaining the VW Collective
                of Milwaukee TikTok. She will also be assisting with Marketing
                Materials, Shirts and Collective Merch. "I have listened to the
                people, I'm hoping to bring you new and exciting VW outtings
                this 2025 Car Show Season!"
              </p>
            </div>
            ...
            <div className='profile-container'>
              ...
              <p className='profile-description'>
                ...
                reaching out to communities and raising awareness of our Club.
                He is Bilingual. Oscar's ability to keep a positive outlook is a
                great asset to our Board.
              </p>
            </div>
            {/* Social Media Info */}
            <div className='profile-container'>
              ...
              />
              <h3 className='profile-name'>
                {boardMembersData.socialMedia.role}
              </h3>
              <p className='profile-description'>
                He will be working to develop and maintain a Website for the
                Club along with ensuring our Social Media footprint stays
                intact. Matt's goals are to add equipment to better capture our
                presence and engage the Volkswagen Community.
              </p>
            </div>
          </div>
          <p>
